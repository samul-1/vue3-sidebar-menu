...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_sidebar_menu_item = resolveComponent(
    "sidebar-menu-item",
    true
  );
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_sidebar_menu_scroll = resolveComponent(
    "sidebar-menu-scroll"
  );
        ...
        !$props.hideToggle
          ? (openBlock(),
            createBlock(
              ...
              [renderSlot(_ctx.$slots, "toggle-icon", {}, () => [_hoisted_2])]
            ))
          : createCommentVNode("v-if", true),
      ],
      6 /* CLASS, STYLE */
